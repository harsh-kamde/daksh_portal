    ...
    <DashboardLayout>
      <div className="profile-setting" style={{ marginBottom: "10rem" }}>
        <div className="w-100 mb-3 rounded mb-5 p-2">
          <h5 className="text-title mb-5 mt-3">Student Course Details</h5>
          ...
          <form className="row form-row" onSubmit={onSubmit}>
            ...
            <h5 className="text-title mb-5 mt-5">Student Details</h5>
            ...
            <div className="col-md-6">
              <div className="form-group mb-2 card-label">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange(e.target.value, "registrationID")
                  }
                />
              </div>
            </div>
